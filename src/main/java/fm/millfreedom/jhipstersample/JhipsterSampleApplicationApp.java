package fm.millfreedom.jhipstersample;

import fm.millfreedom.jhipstersample.config.ApplicationProperties;
import fm.millfreedom.jhipstersample.config.DefaultProfileUtil;
